...
A Claude Code skill for publishing user-defined slash commands to the HartreeWorks/claude-commands repository.
...
```bash
# Run install
npx skills add HartreeWorks/skill--share-command
